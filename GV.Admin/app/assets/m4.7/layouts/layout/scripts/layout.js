...
var Layout = function () {
    ...
    var handleSidebarToggler = function () {
        var Cookies = getCookie('sidebar_closed');
        if (Cookies && Cookies === '1' && App.getViewPort().width >= resBreakpointMd) {
            $('body').addClass('page-sidebar-closed');
            $('.page-sidebar-menu').addClass('page-sidebar-menu-closed');
            $(".page-sidebar-wrapper").addClass("hide-menu");
            $(".page-footer").addClass("page-footer-full");
        }
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            var leftMenu = $(".page-sidebar-wrapper");
            $(".sidebar-search", sidebar).removeClass("open");

            if (body.hasClass("page-sidebar-closed")) {
                body.removeClass("page-sidebar-closed");
                sidebarMenu.removeClass("page-sidebar-menu-closed");
                leftMenu.removeClass("hide-menu");
                $(".page-footer").removeClass("page-footer-full");
                setCookie('sidebar_closed', '0', '1');
            } else {
                body.addClass("page-sidebar-closed");
